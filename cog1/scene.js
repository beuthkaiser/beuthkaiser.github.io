...
define(["exports", "dojo", "dojo/dom-style", "app", "scenegraph", "createScene", "animation", "raster", "shader", "framebuffer", "data", "glMatrix"], //
        ...
        function renderModel(model) {
            ...
            //    debugger;
               ...
               // console.log(modelData);
                ...
                if (!backfaceCulling || normal[2] > 0) //backfaceculling
                {
        ...
        function toggleScanlineIntersections()
    {
        ...
        raster.toggleScanlineIntersections();
        setUpToDate();
    }
        function getDisplayScanlineIntersections() {
            return raster.getDisplayScanlineIntersections;
        }
        ...
        exports.getDisplayScanlineIntersections = getDisplayScanlineIntersections;//
